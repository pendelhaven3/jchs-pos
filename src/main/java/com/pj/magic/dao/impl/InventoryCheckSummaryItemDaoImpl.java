...
public class InventoryCheckSummaryItemDaoImpl extends MagicDao implements InventoryCheckSummaryItemDao {
	...
	private static final String FIND_ALL_BY_INVENTORY_CHECK_SQL =
			...
			+ "   where UNIT_IND_CASE = 'Y' and ACTIVE_UNIT_IND_CASE = 'Y'"
			+ "   union all"
			...
			+ "   where UNIT_IND_TIES = 'Y' and ACTIVE_UNIT_IND_TIES = 'Y'"
			+ "   union all"
			...
			+ "   where UNIT_IND_PACK = 'Y' and ACTIVE_UNIT_IND_PACK = 'Y'"
			+ "   union all"
			...
			+ "   where UNIT_IND_HDZN = 'Y' and ACTIVE_UNIT_IND_HDZN = 'Y'"
			+ "   union all"
			...
			+ "     on p1.PRODUCT2_ID = p2.ID"
			+ "     and p1.UOM_CODE = 'PCS'"
			+ "   where UNIT_IND_PCS = 'Y' and ACTIVE_UNIT_IND_PCS = 'Y'"
			+ " ) a"
			+ " left join ("
